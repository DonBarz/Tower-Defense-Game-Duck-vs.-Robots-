...
public class tower3_script : MonoBehaviour, IPointerClickHandler
{
    ...
    float fire_cooldown;
    float firerate = 0.25f;   //für zeitabstände zwischen einzelnen Schüssen
    public static float max_range = 1.8f;
